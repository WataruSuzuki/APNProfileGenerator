...
input:checked + .switch__toggle {
  -webkit-box-shadow: inset 0 0 0 2px #574bdb;
  box-shadow: inset 0 0 0 2px #574bdb;
...
.bottom-bar {
  ...
  background-image: -webkit-linear-gradient(270deg, #ddd, #ddd 100%);
  background-image: -moz-linear-gradient(270deg, #ddd, #ddd 100%);
  background-image: -o-linear-gradient(270deg, #ddd, #ddd 100%);
  background-image: linear-gradient(180deg, #ddd, #ddd 100%);
}
@media (-webkit-min-device-pixel-ratio: 2), (min-resolution: 192dpi) {
  .bottom-bar {
...
.button--outline {
  background-color: transparent;
  border: 1px solid #8962ed;
  color: #8962ed;
}
.button--outline:active {
  background-color: rgba(137,98,237,0.2);
  border: 1px solid #8962ed;
  color: #8962ed;
  opacity: 1;
}
...
.button-bar__item:first-child > .button-bar__button {
  border-left: 1px solid #ac62ed;
  border-right: 1px solid #ac62ed;
...
.button-bar__button {
  ...
  background-color: transparent;
  color: #ac62ed;
  border: 0px solid #ac62ed;
  border-top: 1px solid #ac62ed;
  border-bottom: 1px solid #ac62ed;
  border-right: 1px solid #ac62ed;
  font-weight: 400;
  padding: 0 8px;
  height: 27px;
...
:active + .button-bar__button {
  background-color: rgba(172,98,237,0.2);
  border: 0px solid #ac62ed;
  border-top: 1px solid #ac62ed;
  border-bottom: 1px solid #ac62ed;
  border-right: 1px solid #ac62ed;
...
:checked + .tab-bar--top-border__button {
  background-color: transparent;
  border-bottom: 4px solid #8962ed;
}
.tab-bar--material {
  background-color: #009688;
