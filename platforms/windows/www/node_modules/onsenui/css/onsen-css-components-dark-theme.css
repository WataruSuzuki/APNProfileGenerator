...
.popover__arrow {
  ...
  background-color: transparent;
  background-image: -webkit-linear-gradient(45deg, #000, #000 50%, transparent 50%);
  background-image: -moz-linear-gradient(45deg, #000, #000 50%, transparent 50%);
  background-image: -o-linear-gradient(45deg, #000, #000 50%, transparent 50%);
  background-image: linear-gradient(45deg, #000, #000 50%, transparent 50%);
